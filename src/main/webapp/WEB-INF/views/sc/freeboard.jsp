	...
	<div class="sub_content_w">
		<div class="sub_right_con">
			...
			<p class="sub_p01 style02">
				<span><span class="col1">학생여러분의 의견</span>을 자유롭게 게시할 수 있는
					곳입니다.</span>학생여러분의 의견을 자유롭게 표현하는 공간입니다. 다만, 게시판의 품위를 유지하기 위해 다음의 글들은 삭제할 수
				있으며, 타인의 명예훼손, 법령위반 등은 처벌될 수 있습니다.
			</p>
			<p class="sub03_5_p01">
				도배글, 상업적 광고물, 음란성 글, 욕설, 지나친 인신공격성 글, 지역감정을 조장하는 글 등 게시판의 품위를 손상하는 글<br>※
				주민번호, 핸드폰번호, 이메일 등 개인정보가 포함된 내용의 글은 등록을 삼가 주세요.
			</p>
			<table cellpadding="0" cellspacing="0" class="table_style01 bor mTl"
				width="100%">
				<colgroup>
					<col width="15%">
					<col width="*">
				...
				<tbody>
					...
					<tr>
						<td colspan="4" class="table_con"><br> <br>현대건설에
							사기를 당해 신용불량자로 최악의 인생을 살아가고 있습니다.<br> <br>아래 주소 검색 하시면
							자세히 보실 수 있습니다. <br>http://blog.daum.net/pig9959/8841277<br>
							<br>우리나라 대기업 현대건설이 너무나 비윤리(형법347조1항 사기)적인 방법으로 상가를 <br>분양하여,<br>저
			...
			<p class="mTm txtR pwcf_p">
				...
				<a class="table_btn01" onclick="gofreeList()">목록</a> <a
					href="" id="table_delete" class="table_btn02 pwcfB">삭제</a> <a
					href="" id="table_modify" class="table_btn03">수정</a> <a href=""
					class="table_btn02">등록</a>
			</p>

			<div id="down">
				<table class="table_style01 mTl" width="100%" summary="이전글, 다음글">
					...
					<tbody>
						<tr>
							...
							<td class="txtL"><a href="" class="view_table_a">부천정보산업고등학교
									괜찮나요?</a>2018-11-10</td>
						</tr>
						<tr>
							<th scope="row" class="first table_bottom_bg table_style01_th">다음글</th>
							<td class="txtL"><a href="" class="view_table_a">부천정보산업고등학교의
									취업률이 100%라는것이 사실입니까?</a>2018-11-30</td>
						</tr>
					</tbody>
				</table>
			</div>
