...
public class PageInfo {
	...
	public String toString() {
		return "PageInfo [page=" + page + ", rowCnt=" + rowCnt + ", blockCnt=" + blockCnt + ", totalCnt=" + totalCnt
				+ ", limitFNum=" + limitFNum + ", limitLNum=" + limitLNum + ", totalPage=" + totalPage + ", totalBlock="
				+ totalBlock + ", sBlock=" + sBlock + ", eBlock=" + eBlock + "]";
	}
